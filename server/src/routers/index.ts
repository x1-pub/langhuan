...
router.post('/redis/redis_modify_ttl', RedisController.modifyTTL)
router.post('/redis/redis_modify_key', RedisController.modifyKey)
router.post('/redis/redis_modify_value', RedisController.modifyValue)
