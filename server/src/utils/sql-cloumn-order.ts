 ...
 */
const generateAlterSQL = (tableName: string, columns: Record<string, string>, newOrder: string[]) => {
 ...
 * 主逻辑：DDL -> 解析列 -> 生成SQL
 */
export const getReorderTableColumnsSql = (ddl: string, tableName: string, newOrder: string[]) => {
