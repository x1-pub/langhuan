    ...
    <main className={styles.main}>
      <section className={styles.heroSection}>
        ...
        <div className={styles.heroContainer}>
          ...
          <div className={styles.heroButtons}>
            <button className={styles.primaryButton} onClick={handleStart}>{t('home.start')}</button>
            <button className={styles.secondaryButton} onClick={openIssues}>{t('home.question')}<LinkOutlined /></button>
          </div>
        </div>
      ...
      <section className={styles.ctaSection}>
        <div className={styles.container}>
          ...
          <button className={styles.ctaButton} onClick={handleStart}>{t('home.freeNow')}</button>
        </div>
      </section>
    </main>
  )
